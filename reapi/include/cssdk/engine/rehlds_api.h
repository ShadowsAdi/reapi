...
typedef IHookChain<int, struct netadr_s *, char*, qboolean, int, char*> IRehldsHook_SV_CheckUserInfo;
typedef IHookChainRegistry<int, struct netadr_s *, char*, qboolean, int, char*> IRehldsHookRegistry_SV_CheckUserInfo;
