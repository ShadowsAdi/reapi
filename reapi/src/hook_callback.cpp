...
{
	vec3_t pOriginCpy;
	pOriginCpy[0] = pOrigin[0];
	pOriginCpy[1] = pOrigin[1];
	pOriginCpy[2] = pOrigin[2];
	...
	callVoidForward(RH_PF_MessageBegin_I, original, msg_dest, msg_type, pOriginCpy, indexOfEdict(ed));
}
